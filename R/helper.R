...
get_association <- function(ranks) {
    names(ranks) <- dplyr::case_when(
        ...
        ranks == "R2" ~ "subroot_2",
        ranks == "D" ~ "domain",
        ranks == "D1" ~ "subdomain_1",
        ranks == "D2" ~ "subdomain_2",
        ranks == "D3" ~ "subdomain_3",
        ranks == "K" ~ "kingdom",
        ranks == "K1" ~ "subkingdom_1",
        ranks == "K2" ~ "subkingdom_2",
        ranks == "K3" ~ "subkingdom_3",
        ranks == "P" ~ "phylum",
        ranks == "P1" ~ "subphylum_1",
        ranks == "P2" ~ "subphylum_2",
        ranks == "P3" ~ "subphylum_3",
        ranks == "P4" ~ "subphylum_4",
        ranks == "P5" ~ "subphylum_5",
        ranks == "P6" ~ "subphylum_6",
        ranks == "P7" ~ "subphylum_7",
        ranks == "P8" ~ "subphylum_8",
        ranks == "P9" ~ "subphylum_9",
        ranks == "C" ~ "class",
        ranks == "C1" ~ "subclass_1",
        ranks == "C2" ~ "subclass_2",
        ranks == "C3" ~ "subclass_3",
        ...
        ranks == "O4" ~ "suborder_4",
        ranks == "F" ~ "family",
        ranks == "F1" ~ "subfamily_1",
        ranks == "F2" ~ "subfamily_2",
        ranks == "F3" ~ "subfamily_3",
        ranks == "F4" ~ "subfamily_4",
        ranks == "F5" ~ "subfamily_5",
        ranks == "F6" ~ "subfamily_6",
        ranks == "F7" ~ "subfamily_7",
        ranks == "G" ~ "genus",
        ranks == "G1" ~ "subgenus_1",
        ranks == "G2" ~ "subgenus_2",
        ranks == "S" ~ "species",
        ranks == "S1" ~ "subspecies_1",
        ranks == "S2" ~ "subspecies_2"
    )
    return(ranks)
}
