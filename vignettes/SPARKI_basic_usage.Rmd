...
knitr::opts_knit$set(root.dir = "/home/ubuntu/git_clones/sparki/")
...
A standard report can be generated with the option `--report` when running Kraken2 on the command line; please note that the flag `r I("--report-minimizer-data")`
