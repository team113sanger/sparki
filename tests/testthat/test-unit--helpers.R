...
test_that("get_test_reference returns valid inspect.txt path", {
...
test_that("get_local_tmp_dir creates a directory", {
...
test_that("get_local_tmp_dir creates unique directories", {
