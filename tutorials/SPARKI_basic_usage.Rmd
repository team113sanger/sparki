...
merged_reports <- add_DBinfo(merged_reports, ref_db)
```

```{r assessing_significance, echo = TRUE}
merged_reports <- subsetReports(merged_reports, include_human = FALSE)
merged_reports <- assess_ratioMinimisers(merged_reports)
merged_reports <- assess_statSig(merged_reports, ref_db)
```
